...
const translations = {
  ja: {
    appTitle: '人生資産プランナー', appSubtitle: '現在から100歳まで、家族の収入・支出・資産推移を見通す', realMoney: '現在価値', household: '家族情報', events: 'ライフイベント', dashboard: '生涯資産シミュレーション', tools: 'ツール・比較', addSpouse: '配偶者を追加', addChild: '子どもを追加', addEvent: 'イベントを追加', annualDetails: '年次明細を見る', disclaimer: '本結果は一定の前提に基づく試算であり、投資・税務・法務上の助言ではありません。', localSave: 'この端末に保存', language: '表示言語',
  ...
  zh: {
    appTitle: '人生财富规划器', appSubtitle: '从现在到100岁，看清家庭收入、支出与资产轨迹', realMoney: '按今天购买力', household: '家庭属性', events: '人生事件', dashboard: '生涯财富预测', tools: '工具与情景', addSpouse: '添加配偶', addChild: '添加孩子', addEvent: '添加事件', annualDetails: '查看年度明细', disclaimer: '结果为确定性估算，不构成投资、税务或法律建议。', localSave: '本地保存', language: '显示语言',
