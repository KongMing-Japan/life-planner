...
const translations = {
  ja: {
    ...
    useJapanTax: '日本所得税・社会保険料エンジンを使用', monthlyNisa: '新NISA 月間積立額', monthlyIdeco: 'iDeCo 月間積立額', monteCarloSuccess: 'モンテカルロ資産存続率', monteCarloTitle: '1,000回市場波动概率拟合',
    whatIfTitle: 'Quicken リアルタイム要件シミュレーション (What-If Interactive)',
    whatIfRetireAge: '退職年齢スライダー', whatIfNisa: 'NISA月額積立スライダー', whatIfRetireSpend: '退職後生活費スライダー',
    quickenAdviceTitle: 'FP 最適化プランのアドバイス (Quicken Recommendations)',
    bottomLedgerTitle: '逐年財務監査帳簿 (Annual Audit Ledger)',
  ...
  zh: {
    ...
    useJapanTax: '启用日本所得税与社会保险计算引擎', monthlyNisa: '新NISA 每月定投', monthlyIdeco: 'iDeCo 每月定投', monteCarloSuccess: '蒙特卡洛资产生存率', monteCarloTitle: '1,000次市场波动概率拟合',
    whatIfTitle: 'Quicken 实时情景推演 (What-If Interactive)',
    whatIfRetireAge: '退休年龄滑动条', whatIfNisa: 'NISA每月定投滑动条', whatIfRetireSpend: '退休后生活费滑动条',
    quickenAdviceTitle: 'FP 理财优化建议 (Quicken Recommendations)',
    bottomLedgerTitle: '逐年财务审计账簿 (Annual Audit Ledger)',
